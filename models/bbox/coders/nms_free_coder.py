...
class NMSFreeCoder(BaseBBoxCoder):
    def __init__(self,
        ...
        self.static_classes = static_classes or []
    ...
    def decode_single(self, cls_scores, bbox_preds):
        ...
        if self.post_center_range is not None:
            ...
            # Zero velocity for static classes
            if self.static_classes and boxes3d.shape[-1] >= 9:
                for cls_id in self.static_classes:
                    static_mask = labels == cls_id
                    boxes3d[static_mask, 7:9] = 0.0
