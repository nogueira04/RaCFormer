...
def main():
    ...
    payload = {
        ...
        "delta_vs_s0": deltas,
        "gate_vs_s0": s0_gate,
        "note": "RCBEVDet/BEV-Radar-inspired zero-init radar occupancy+RCS BEV residual.",
    }
    (out_dir / "summary_metrics.json").write_text(json.dumps(payload, indent=2, sort_keys=True))

    lines = [
        "# S0 RCS BEV residual summary",
        "",
        "Zero-init radar occupancy + RCS BEV residual trained on the S0 day-only subset.",
        "",
