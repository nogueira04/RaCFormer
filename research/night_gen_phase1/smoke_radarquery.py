...
CONFIG = "configs/racformer_train2k_day_radarquery_research.py"
...
def main():
    assert torch.cuda.is_available(), "Branch D smoke requires compute-node CUDA"
    ...
    assert head.radar_query_topk == 180
    ...
    if head.radar_query_topk < head.num_query:
