...
def main():
    ...
    payload = {
        ...
        "delta_vs_s0": deltas,
        "gate_vs_s0": s0_gate,
        "note": "Occupancy-dominant ablation of the RCS BEV residual with RCS effectively muted.",
    }
    (out_dir / "summary_metrics.json").write_text(json.dumps(payload, indent=2, sort_keys=True))

    lines = [
        "# S0 occupancy-dominant BEV residual summary",
        "",
        "Zero-init radar occupancy-dominant BEV residual trained on the S0 day-only subset.",
        "",
