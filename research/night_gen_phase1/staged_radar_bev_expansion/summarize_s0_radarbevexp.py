...
def main():
    ...
    lines = [
        "# S0 radar BEV expansion summary",
        "",
        "RobuRCDet-style fixed local expansion over encoded radar BEV features, trained on the S0 day-only subset.",
        "",
