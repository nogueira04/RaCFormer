...
def main():
    ...
    payload = {
        ...
        "note": "Epoch-1 early full-val screening only; final decision remains epoch_12 eval.",
    }
    (out_dir / "summary_metrics.json").write_text(json.dumps(payload, indent=2, sort_keys=True))

    lines = [
        "# S0 radar BEV expansion epoch-1 screening summary",
        "",
        "Early full-val screening for the epoch-1 checkpoint while epoch 12 continues training.",
