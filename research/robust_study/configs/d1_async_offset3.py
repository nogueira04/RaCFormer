# (d1) radar-camera async, offset 3 sweep step(s) ~= 231 ms
...
# the frame-t element included, is aggregated from 3 sweep step(s) earlier; the camera path
...
#     --config research/robust_study/configs/d1_async_offset3.py \
