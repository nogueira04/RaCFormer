# (d1) radar-camera async, offset 2 sweep step(s) ~= 154 ms
...
# the frame-t element included, is aggregated from 2 sweep step(s) earlier; the camera path
...
#     --config research/robust_study/configs/d1_async_offset2.py \
