...
Loss-weighting variant: generated keyframe samples contribute 0.25x detection/depth
loss while ungenerated samples remain at 1.0x.
"""
...
train_pipeline = [
    dict(
        ...
        manifest_path="research/night_gen_phase1/manifests/phase1_t10_seed20260425_ratio18p75_manifest.json",
        to_float32=False,
        color_type="color",
        generated_sample_weight=0.25,
    ),
