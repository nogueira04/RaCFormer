"""
RaCFormer Optimized Configuration for Jetson Orin AGX
Tier 2.3: Reduced temporal frames (8 -> 4)
Tier 2.4: Reduced query count (900 -> 400)

This configuration trades some accuracy for significantly improved inference speed.
Expected speedup: ~2x compared to full configuration
Expected accuracy: ~95-97% of original mAP/NDS

Usage:
    python profile_inference.py configs/racformer_r50_nuimg_704x256_f4_optimized.py \
        checkpoints/racformer.pth --fp16 --detailed
"""
...
# TIER 2.3: Reduced temporal frames (8 -> 4)
# This halves the temporal processing overhead while maintaining
# reasonable tracking accuracy for most objects
num_frames = 4  # Changed from 8
...
# TIER 2.4: Reduced query count (900 -> 400)
# num_ray * num_clusters = total queries
# Original: 150 * 6 = 900 queries
# Optimized: 100 * 4 = 400 queries
num_clusters = 4  # Changed from 6
num_ray = 100     # Changed from 150
num_query = num_ray * num_clusters  # 400 queries
