"""
RaCFormer 3-Layer Configuration for Jetson Orin AGX
- Reduced decoder layers: 6 -> 3 (shared weights, ~50% transformer speedup)
- 8 temporal frames (weight-compatible, no retraining needed)
- Queries kept at 900

Usage:
    NUSCENES_VERSION=v1.0-mini python profile_inference.py \
        configs/racformer_r50_nuimg_704x256_3layers_mini.py \
...
# Evenly sampled 3-layer subset preserving start/end range:
