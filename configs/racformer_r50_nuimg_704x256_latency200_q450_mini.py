...
and one shared decoder pass plus 450 evenly-spaced query seeds. It is intended for latency validation and requires
retraining or calibration before accuracy-sensitive use.

Usage:
    NUSCENES_VERSION=v1.0-mini python profile_inference.py \
        configs/racformer_r50_nuimg_704x256_latency200_q450_mini.py \
...
num_clusters = 6
num_ray = 75
num_query = num_ray * num_clusters  # 450
